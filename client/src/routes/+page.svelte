<script lang="ts">
	...
	const testimonials = [
		...
		},
		{
			...
			stars: 5,
			text: 'From booking to care delivery the whole experience was flawless. I will absolutely be using SES Homecare & Medical Supplies again.',
			color: '#0d3d2d',
...
<svelte:head>
	<title>SES Homecare & Medical Supplies - Home Nursing Services</title>
...
<section class="py-20 md:py-32 bg-white">
	<div class="container mx-auto px-6 sm:px-8 lg:px-12">
		<div class="text-center mb-12 md:mb-20">
			<h2 class="text-3xl font-bold text-gray-900 sm:text-4xl md:text-5xl mb-5">Why Choose SES Homecare?</h2>
	...
	<div class="container mx-auto px-6 sm:px-8 lg:px-12 mb-10 md:mb-14">
		<div class="text-center">
			...
			<p class="text-xl text-gray-500 max-w-xl mx-auto">
				Real experiences from families who trust SES Homecare & Medical Supplies
			</p>
		</div>
	</div>
