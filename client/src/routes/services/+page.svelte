	...
	<div class="container mx-auto px-6 sm:px-8 lg:px-12">
		<div class="mx-auto max-w-3xl text-center">
			...
			<p class="text-xl text-gray-600 leading-relaxed">
				Professional home healthcare services tailored to your needs. Delivering compassionate, expert care where you feel most comfortable.
			</p>
		</div>
	</div>
</section>
			...
			{#each services as service}
				<div class="group rounded-2xl bg-white overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100">
					...
					<div class="relative h-64 overflow-hidden">
						...
						<div class="absolute bottom-4 left-4 inline-flex items-center justify-center rounded-xl bg-emerald-600 p-3">
							...
							<ul class="space-y-3">
								{#each service.features as feature}
									<li class="flex items-start text-base text-gray-600">
										<svg class="mr-3 h-5 w-5 flex-shrink-0 text-emerald-600 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
